...
function optionsframework_options() {
    ...
    $options[] = array(
		'name' => __( 'Mobile No:', 'website' ),
		'placeholder' => __( 'Enter Mobile No.', 'website' ),
		'id' => 'mobile',
		'std' => '+ 0406 583 082',
		'type' => 'text'
	);
    ...
    $options[] = array(
		'name' => __( 'Another Email', 'website' ),
		'placeholder' => __( 'Another Email', 'website' ),
		'id' => 'time',
		'type' => 'text'
	);
    ...
    $options[] = array(
		'name' => __( 'About:', 'website' ),
		'placeholder' => __( 'About Your Company.', 'website' ),
		'id' => 'about',
		'type' => 'textarea'
	);
    ...
    $options[] = array(
		'name' => __( 'copyright:', 'website' ),
		'placeholder' => __( 'copyright', 'website' ),
		'id' => 'copyright',
		'std' => '',
		'type' => 'text'
	);
